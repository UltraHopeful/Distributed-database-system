...
//    public static String valuedelimiter= "\u2087";
    ...
    public void GeneralLogsWrite( String query_type,String db_name, String tablecount) {
        try {
            ...
            String general_log_text[] = { query_type + valuedelimiter + db_name + valuedelimiter + getDateandTime() + valuedelimiter + tablecount  +delimiter};
    ...
    public void EventLogsWrite(String user_name, String dbname, String tablename, String query_type)
    {
        try{
            String event_log_text[]={user_name + valuedelimiter + dbname + valuedelimiter + getDateandTime() + valuedelimiter +tablename + valuedelimiter +query_type + valuedelimiter + EventLogStatus()  +delimiter};
    ...
    public void QueryLogsWrite(String user_name, String dbname, String query){
            try{
                String query_log_text[]={ user_name + valuedelimiter + dbname + valuedelimiter +query+ valuedelimiter + getDateandTime() +delimiter};
