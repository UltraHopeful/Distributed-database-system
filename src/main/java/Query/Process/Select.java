...
public class Select {
            ...
            if (selectParseMatcher.find()) {
                ...
                if(isValidQuery) {
                    if (conditionColumnName == null) {
                        ...
                        printRows(rowData, columnNamesList, columnIndexToShowList, indexToSelectList);
                    } else {
                        int conditionColumnIndex = columnNamesList.indexOf(conditionColumnName);
                        indexToSelectList = common.getSelectedRows(tableName, conditionColumnIndex, condition, conditionValue);
    ...
    private void printRows(List<String[]> rowData,List<String> columnNamesList,List<Integer> columnIndexToShowList,List<Integer> listOfIndexToPrint){
